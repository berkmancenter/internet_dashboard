Template.GSMA3GWidget.onCreated(function() {
  var template = this;
...
Template.GSMA3GWidget.onRendered(function() {
  var template = this;
  ...
  this.autorun(function() {
    ...
    var $graph = template.$('.threeg-connections');
    ...
    pnts = [ { label: '3G Connections', values: pnts } ];
