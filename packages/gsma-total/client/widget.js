Template.GSMATotalWidget.onCreated(function() {
  var template = this;
...
Template.GSMATotalWidget.helpers({
...
Template.GSMATotalWidget.onRendered(function() {
  var template = this;
  ...
  this.autorun(function() {
    ...
    var $graph = template.$('.mobile-connections');
    ...
    pnts = [ { label: 'Mobile Connections', values: pnts } ];
